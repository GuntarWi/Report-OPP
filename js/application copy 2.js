...
const CasinoLetter = ["X","Y","W","Q","T","E"]
...
for(i = 0; i < uniqueCasinoId.length; i++){
    ...
    playerList.append('<button type="button" value="'+  uniqueCasinoId[i] +'"letter="'+  CasinoLetter[i] +'" casino="'+  uniqueCasinoId[i] +'">'+ uniqueCasinoId[i] +'</button>')
